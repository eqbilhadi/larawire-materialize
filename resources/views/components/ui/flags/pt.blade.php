...
<div style="height: {{ $size }}; width: {{ $size }}; object-fit: cover;">
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="flag-icon-css-pt"
        viewBox="0 0 512 512" style="width: calc(var(0,25rem) * 5); height: calc(var(0,25rem) * 5); border-radius: calc(infinity * 1px); object-fit: cover;">
